...
const IndexPage = ({ classes }) => (
  <Layout>
    ...
    <p>
      Poodle is an email client. It is completely compatible with existing email
      service providers. All if the features that Poodle introduces operate over
      email exchanges - there are no new servers, and your data will never be
      transmitted to the creators of Poodle or to a third-party. Poodle
      exchanges gracefully degrade - all of the information in messages produced
      by Poodle is accessible to readers using traditional email clients.
    </p>
